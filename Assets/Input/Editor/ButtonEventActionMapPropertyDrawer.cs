...
public class ButtonEventActionMapPropertyDrawer : PropertyDrawer {
  public override VisualElement CreatePropertyGUI(SerializedProperty property) {
    ...
    flow.RegisterValueChangeCallback(v => {
      flow.style.backgroundColor = (ButtonEventFlowBehavior)v.changedProperty.enumValueIndex switch {
        ButtonEventFlowBehavior.Block => Color.red,
        ButtonEventFlowBehavior.Pass => Color.white,
        _ => Color.green
      };
    });
